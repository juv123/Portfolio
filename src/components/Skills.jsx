...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-screen bg-[#0a192f] text-gray-300'>
      {/* Container */}
      <div className='max-w-[800px] mx-28 pt-16 flex flex-col justify-center w-full h-full'>
          <div>
              <p className='text-4xl font-bold inline border-b-4 border-pink-600 '>Skills</p>
              <p className='py-8 text-2xl'> The Following are the technologies I've worked with:-</p>
          </div>
          ...
          <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-6 text-center py-8'>
              ...
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-20 mx-auto' src={tailwind_css} alt="HTML icon" />
